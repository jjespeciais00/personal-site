          ...
          <div>
            ...
            >
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#FFD700] via-[#00e6a1] to-[#00bfff] text-black font-body font-bold text-base px-8 py-4 rounded-sm transition-all duration-200 hover:shadow-[0_0_25px_rgba(255,215,0,0.45)] hover:scale-105 active:scale-95"
              >
